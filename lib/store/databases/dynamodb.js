...
_.extend(DynamoDB.prototype, {
  ...
  connect: function(callback) {
    var self = this;
    console.log("KEPELELELELELE 01 ", self.options, process.env['AWS_DYNAMODB_ENDPOINT'])
  ...
  getUndispatchedCommands: function (options, callback) {
    console.log("====================================== ")
    console.log(" getUndispatchedCommands ")
    console.log("====================================== ")
    if (!callback) {
      callback = options;
      options = {};
  ...
  setCommandToDispatched: function (cmdId, sagaId, callback) {
    console.log("====================================== ")
    console.log(" setCommandToDispatched ")
    console.log("====================================== ")
